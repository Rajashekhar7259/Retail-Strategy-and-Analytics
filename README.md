...
- correlation between the trial storeâ€™s performance and each control storeâ€™s performance
- standardised metric based on the absolute difference between the trial storeâ€™s performance and each control storeâ€™s performance
